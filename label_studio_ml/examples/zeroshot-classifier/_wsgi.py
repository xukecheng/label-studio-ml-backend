...
from model import ZeroShotClassifier
...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + ZeroShotClassifier.__name__ + '" instance creation..')
        model = ZeroShotClassifier(**kwargs)

    app = init_app(
        model_class=ZeroShotClassifier,
    ...
    # for uWSGI use
    app = init_app(model_class=ZeroShotClassifier)
